...
@interface MWWeiboPictureMetadata : NSObject <NSCoding>
...
@interface MWWeiboPicture : NSObject <NSCoding>
@property (nonatomic, strong) NSString *picID;
@property (nonatomic, strong) NSString *objectID;
@property (nonatomic, assign) int photoTag;
@property (nonatomic, assign) BOOL keepSize;
@property (nonatomic, strong) MWWeiboPictureMetadata *thumbnail;
@property (nonatomic, strong) MWWeiboPictureMetadata *bmiddle;
@property (nonatomic, strong) MWWeiboPictureMetadata *middlePlus;
@property (nonatomic, strong) MWWeiboPictureMetadata *large;
@property (nonatomic, strong) MWWeiboPictureMetadata *largest;
@property (nonatomic, strong) MWWeiboPictureMetadata *original;
@end

@interface MWWeiboURL : NSObject <NSCoding>
...
@interface MWWeiboUser : NSObject <NSCoding>
